		...
		else
		{
				...
				if (TileMap.mapID != 51)
				{
					...
					else
					{
						...
						if (template.npcTemplateId == 47)
							num = 40;
						if (TileMap.mapID != 113)
							mFont.tahoma_7_yellow.drawString(g, template.name + " [" + template.npcTemplateId + "]", cx, cy - ch - num - mFont.tahoma_7.getHeight(), mFont.CENTER, mFont.tahoma_7_grey);
					}
				}
				dyEff = 65;
			}
			else if (duahau != null)
			{
				...
				if (Char.myCharz().npcFocus != null && Char.myCharz().npcFocus.Equals(this))
					...
					mFont.tahoma_7_yellow.drawString(g, template.name + " [" + template.npcTemplateId + "]", cx, cy - ch - 8 - mFont.tahoma_7.getHeight() - num2 + 16, mFont.CENTER, mFont.tahoma_7_grey);
			}
		}
	}
